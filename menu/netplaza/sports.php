 ...
 */
	...
	$THISPAGE = Array ( "NAME" => "SPORTS",
						"URL" => "{$SETUP["URL"]}/menu/netplaza/sports.php",
						"TIP" => "스포츠" );
	
	$MENU->ADD( "P", "이전메뉴", "{$SETUP["URL"]}/menu/netplaza/", "이전메뉴" );
	$MENU->ADD( "ㅔ", "이전메뉴", "{$SETUP["URL"]}/menu/netplaza/", "이전메뉴" );
